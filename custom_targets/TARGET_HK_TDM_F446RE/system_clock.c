...
uint8_t SetSysClock_PLL_HSI(void)
{
    ...
    RCC_OscInitStruct.PLL.PLLP            = RCC_PLLP_DIV2; // PLLCLK = 50 MHz (100 MHz / 2)
    ...
    RCC_ClkInitStruct.ClockType      = (RCC_CLOCKTYPE_SYSCLK | RCC_CLOCKTYPE_HCLK | RCC_CLOCKTYPE_PCLK1 | RCC_CLOCKTYPE_PCLK2);
    RCC_ClkInitStruct.SYSCLKSource   = RCC_SYSCLKSOURCE_PLLCLK;
    RCC_ClkInitStruct.AHBCLKDivider  = RCC_SYSCLK_DIV1; // 50 MHz
    RCC_ClkInitStruct.APB1CLKDivider = RCC_HCLK_DIV2;  //  25 MHz
    RCC_ClkInitStruct.APB2CLKDivider = RCC_HCLK_DIV1;  //  50 MHz
